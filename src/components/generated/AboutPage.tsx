...
export default function AboutPage({
  ...
  const brandValues = [{
    ...
    mpid: "1928f098-1535-425b-bf90-7d4c6b8efbba"
  }, {
    icon: Sparkles,
    title: "Authenticity",
    ...
    mpid: "66d01c98-6446-4ff8-b5d4-6d9d6e7831ad"
  }, {
    icon: Leaf,
    ...
    mpid: "65f563ce-b017-4c36-b53a-33110c66d975"
  }, {
    icon: Users,
    ...
    mpid: "c7c6d485-5ebd-4eae-9c85-594e5289547d"
  }] as any[];
  const journeyMilestones = [{
    ...
    mpid: "e135e815-3628-4d57-aac4-ba14dc620ad3"
  }, {
    year: "2024",
    ...
    mpid: "3a3f0d06-9c9e-4b4f-a44a-be15308f0427"
  }, {
    year: "October 2024",
    title: "First Retreat",
    ...
    mpid: "e563068b-5b97-4d09-82fc-a5b5171e2be9"
  }, {
    year: "December 2024",
    title: "The Leap",
    ...
    mpid: "ce1efabb-d97a-44d2-a112-1035041d1ed3"
  }, {
    year: "2025",
    ...
    mpid: "089086c8-7981-426f-8014-3373bccfaeaf"
  }] as any[];
  return <SortableContainer dndKitId="8bc91db4-a888-48b6-bf75-d66f13c99ac5" containerType="regular" prevTag="div" className="min-h-screen bg-[#F5F1E8]" data-magicpath-id="0" data-magicpath-path="AboutPage.tsx">
      {/* Hero Section */}
      <SortableContainer dndKitId="9dbdfa0c-18f4-4758-b600-d0b2fa22fe82" containerType="regular" prevTag="section" className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden" data-magicpath-id="1" data-magicpath-path="AboutPage.tsx">
        ...
        <SortableContainer dndKitId="61d674bf-fea1-48b6-8a88-34610b00adae" containerType="regular" prevTag="div" className="relative z-10 text-center text-white px-4 sm:px-6 max-w-4xl" data-magicpath-id="3" data-magicpath-path="AboutPage.tsx">
      ...
      {/* Journey Timeline */}
      <SortableContainer dndKitId="db680718-b99f-41f0-9659-34c048a43ac3" containerType="regular" prevTag="section" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6" data-magicpath-id="6" data-magicpath-path="AboutPage.tsx">
        <SortableContainer dndKitId="f83d8026-020d-49c9-b0c8-edae3788d4f2" containerType="regular" prevTag="div" className="max-w-4xl mx-auto" data-magicpath-id="7" data-magicpath-path="AboutPage.tsx">
          <SortableContainer dndKitId="79eec211-3317-48d5-9974-8a646ca3ec13" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          <SortableContainer dndKitId="40a87ce6-b527-4fca-bb87-1b8bed95b452" containerType="collection" prevTag="div" className="space-y-12 sm:space-y-16" data-magicpath-id="11" data-magicpath-path="AboutPage.tsx">
      ...
      <SortableContainer dndKitId="268ffc53-eb58-4c1e-8414-fa4e0f942dad" containerType="regular" prevTag="section" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white" data-magicpath-id="21" data-magicpath-path="AboutPage.tsx">
        <SortableContainer dndKitId="873ae005-9f91-4742-9abe-e8df54bf7559" containerType="regular" prevTag="div" className="max-w-6xl mx-auto" data-magicpath-id="22" data-magicpath-path="AboutPage.tsx">
          <SortableContainer dndKitId="4c21fb69-03e6-4678-a39d-e9609b9a33f7" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          <SortableContainer dndKitId="eb000c7d-cf3b-4906-80c4-682255622d39" containerType="collection" prevTag="div" className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-10" data-magicpath-id="26" data-magicpath-path="AboutPage.tsx">
      ...
      <SortableContainer dndKitId="eb0e10da-7d69-4c26-8ac8-dbe4042af08c" containerType="regular" prevTag="section" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-[#8B9B7F]" data-magicpath-id="33" data-magicpath-path="AboutPage.tsx">
        <SortableContainer dndKitId="d7923673-2793-4221-8b09-9d8e782d3457" containerType="regular" prevTag="div" className="max-w-4xl mx-auto" data-magicpath-id="34" data-magicpath-path="AboutPage.tsx">
          <SortableContainer dndKitId="57c78f70-8440-406e-b421-94b354f7149b" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          duration: 0.6
            ...
            <SortableContainer dndKitId="5a4066ef-d957-488e-bfce-0cb5d8fd3be7" containerType="regular" prevTag="div" className="bg-white/10 backdrop-blur-sm rounded-lg p-6 sm:p-8 md:p-10" data-magicpath-id="37" data-magicpath-path="AboutPage.tsx">
      ...
      <SortableContainer dndKitId="3a522033-0075-42f0-87f9-825c8a699d5a" containerType="regular" prevTag="section" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-[#F5F1E8]" data-magicpath-id="40" data-magicpath-path="AboutPage.tsx">
        <SortableContainer dndKitId="3bf4d0a8-716d-40fa-a206-27bc66706125" containerType="regular" prevTag="div" className="max-w-6xl mx-auto" data-magicpath-id="41" data-magicpath-path="AboutPage.tsx">
          <SortableContainer dndKitId="c968df8c-9efc-4ff8-8bbd-7fcadf9c451f" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6" data-magicpath-id="44" data-magicpath-path="AboutPage.tsx">
            {['https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=600&q=80', 'https://images.unsplash.com/photo-1607631568010-a87245c0daf8?w=600&q=80', 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80', 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=600&q=80', 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=600&q=80', 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=600&q=80'].map((image, index) => <SortableContainer dndKitId="45393841-0b42-4a71-b84e-e2cd322ea566" containerType="regular" prevTag="motion.div" key={index} initial={{
            opacity: 0,
            scale: 0.9
          }} whileInView={{
            opacity: 1,
      ...
      {/* Call to Action */}
      <SortableContainer dndKitId="c5be2e2d-7b73-436f-8fc1-786c40a195ae" containerType="regular" prevTag="section" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-white" data-magicpath-id="47" data-magicpath-path="AboutPage.tsx">
        <SortableContainer dndKitId="b826109a-798c-44e2-9e66-0df3baf50a10" containerType="regular" prevTag="div" className="max-w-4xl mx-auto text-center" data-magicpath-id="48" data-magicpath-path="AboutPage.tsx">
          <SortableContainer dndKitId="5f2f77f1-37b7-4584-b533-d6d9c8885bc2" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          duration: 0.6
            ...
            <SortableContainer dndKitId="72e27d60-ba15-427d-9290-b78cd1a05776" containerType="regular" prevTag="div" className="flex flex-col sm:flex-row gap-4 justify-center" data-magicpath-id="52" data-magicpath-path="AboutPage.tsx">
